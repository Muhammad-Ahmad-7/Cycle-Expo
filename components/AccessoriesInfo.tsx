...
import { accessories_images, cycle_images, parts_images } from './image-uri';
import Animated, {
    useSharedValue,
    useAnimatedStyle,
    withSpring,
...
const AccessoriesInfo = ({ item }: any) => {
    ...
    return (
        <ScrollView style={[styles.container, { width: img_width }]}>
            ...
            {/* Animated Image */}
            <Animated.Image
                source={accessories_images[item.image]}
